    ...
    <style>
        * {
        ...
        nav {
            ...
            position:sticky;
            box-shadow: 5px 5px 4px rgb(151, 148, 148);
        ...
        .thought {
            ...
            height: 33vh;
            margin: 30px;
            box-shadow: 5px 5px 2px rgb(151, 148, 148);
        ...
        .medi button {
            ...
            margin-top: 10px;
            border-radius: 5px;
            background-color: rgb(160, 142, 77);
        }
...
<body>
    ...
    <div class="content">
        ...
        <div class="service">
            <div class="medi">
                <img src="medi.png"> <button><a href="meditation.html">Meditation</a></button>
            </div>
            <div class="yoga">
                <img src="yoga.png"><button><a href="yogapage.html">Yoga</a></button>
            </div>
        </div>
    </div>
    <script>
